...
public class InvalidData {
    ...
    public InvalidData(final int type) {
        this.type = type;
    }
    ...
    public void setInvalidValues(final List<String> invalidValues) {
    ...
    public void setInvalidRange(final List<String> invalidRange) {
